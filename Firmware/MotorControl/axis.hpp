...
public:
    ...
    struct Config_t {
        bool startup_motor_calibration = true;//false;   //<! run motor calibration at startup, skip otherwise
        bool startup_encoder_index_search = true;//false; //<! run encoder index search after startup, skip otherwise
